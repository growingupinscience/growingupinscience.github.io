  ...
  return (
    <section id = "about">
        <div className = "light section" style = {style}>
          ...
          {/* first block: the lede sits beside the stat bubbles */}
          ...
          <p>
          Have you ever wondered what your advisor struggled with as a graduate
          student? What they struggle with now? Growing up in Science is a
          conversation series featuring personal narratives of becoming and
          being a scientist.
          </p>
          <p>
          ...
          {/* second block: the fuller description runs under both columns */}
          ...
          and work-life balance, but these topics are always embedded in the
          speaker's broader narrative.
          </p>
          <p>
